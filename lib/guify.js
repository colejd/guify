...
var Range = function (_EventEmitter) {
    ...
    function Range(root, opts, theme, uuid) {
        ...
        if (opts.scale === 'log') {
            ...
            _this.precision = (0, _isNumeric2.default)(opts.precision) ? opts.precision : 3;
            _this.logScale = (_this.max - _this.min) / (_this.maxPos - _this.minPos);

            _this.initial = (0, _isNumeric2.default)(opts.initial) ? opts.initial : (_this.min + _this.max) * 0.5;
            ...
            _this.precision = (0, _isNumeric2.default)(opts.precision) ? opts.precision : 3;
            _this.step = (0, _isNumeric2.default)(opts.step) ? opts.step : 10 / Math.pow(10, 3); // Default is the lowest possible number given the precision. When precision = 3, step = 0.01.
        ...
        if ((0, _isNumeric2.default)(_this.step)) {
        ...
        _this.valueComponent = __webpack_require__(6)(_this.container, _this._Position(_this.initial), theme, '16%');
        // Add ARIA attribute to input based on label text
    ...
    _createClass(Range, [{
        ...
        value: function _Value(position) {
            if (this.scale === 'log') {
                ...
                var rangePos = (position - this.minPos) * this.logScale + this.min;
