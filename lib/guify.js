...
var prefix = __webpack_require__(19)
var toCamelCase = __webpack_require__(20)
var cache = { 'float': 'cssFloat' }
var addPxToStyle = __webpack_require__(23)
...
module.exports.getCss = __webpack_require__(46);
...
module.exports = {
    light: {
        ...
        colors: {
            ...
            background2hover: 'rgb(190, 190, 190)',
...
var _commonStyle = __webpack_require__(2);
...
module.exports = csjs(_templateObject, _commonStyle2.default.theme.colors.background1, _commonStyle2.default.theme.sizing.menuBarHeight, _commonStyle2.default.theme.sizing.menuBarHeight, _commonStyle2.default.theme.sizing.menuBarContentHeight, _commonStyle2.default.theme.sizing.menuBarContentHeight, _commonStyle2.default.theme.colors.text1, _commonStyle2.default.theme.sizing.menuBarContentHeight, _commonStyle2.default.theme.sizing.menuBarHeight, _commonStyle2.default.theme.sizing.menuBarContentHeight, _commonStyle2.default.theme.colors.text1, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.background2hover, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.text2);
...
var _componentManager = __webpack_require__(25);

var _menuBar = __webpack_require__(71);

var _panel = __webpack_require__(72);

var _toastArea = __webpack_require__(75);
...
var GUI = function () {
    ...
    _createClass(GUI, [{
        ...
        value: function _Register(opts) {
            ...
            var component = this.componentManager.Create(opts.type, root, opts);
...
var ComponentManager = exports.ComponentManager = function () {
    function ComponentManager() {
        ...
        this.components = {
            ...
            'folder': __webpack_require__(66),
            'file': __webpack_require__(68),
            'display': __webpack_require__(70)
        };
    }

    _createClass(ComponentManager, [{
        key: 'Create',
        value: function Create(type, root, opts) {
            if (this.components[type] === undefined) {
                throw new Error('No component type named \'' + type + '\' exists.');
            }

            return new this.components[type](root, opts, _theme.theme, this.uuid);
        }
    }]);
...
var Title = function Title(root, opts, theme) {
    ...
    var container = __webpack_require__(1)(root, opts.label, theme);
    (0, _domCss2.default)(container, {
        //'font-size': '13px'
    });
...
var Range = function (_EventEmitter) {
    ...
    function Range(root, opts, theme, uuid) {
        ...
        _this.valueComponent = __webpack_require__(14)(container, _this.ScaleValue(opts.initial), theme, '11%');
...
var trackColor = _commonStyle2.default.theme.colors.background2;
var thumbColor = _commonStyle2.default.theme.colors.foreground1;
var thumbHighlight = _commonStyle2.default.theme.colors.background2hover;

module.exports = csjs(_templateObject, trackColor, thumbColor, thumbHighlight, trackColor, _commonStyle2.default.theme.colors.background2hover, thumbColor, trackColor, trackColor, _commonStyle2.default.theme.colors.background2hover, _commonStyle2.default.theme.colors.background2hover, thumbColor, thumbHighlight, thumbHighlight);
...
var csjs = __webpack_require__(35);
...
var extractExtends = __webpack_require__(37);
var composition = __webpack_require__(7);
var isComposition = composition.isComposition;
var ignoreComposition = composition.ignoreComposition;
var buildExports = __webpack_require__(38);
var scopify = __webpack_require__(39);
...
var fileScoper = __webpack_require__(40);
var replaceAnimations = __webpack_require__(43);
...
module.exports = csjs(_templateObject, _commonStyle2.default.theme.colors.text2, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.sizing.labelWidth, _commonStyle2.default.theme.colors.text2, _commonStyle2.default.theme.colors.background2hover, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.text2);
...
module.exports = csjs(_templateObject, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.background2hover, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.foreground1, _commonStyle2.default.theme.colors.background2hover, _commonStyle2.default.theme.colors.background2hover, _commonStyle2.default.theme.colors.foreground1, _commonStyle2.default.theme.colors.background2);
...
var Select = function (_EventEmitter) {
    ...
    function Select(root, opts, theme, uuid) {
        ...
        container = __webpack_require__(1)(root, opts.label, theme);
        __webpack_require__(5)(container, opts.label, theme);
...
module.exports = csjs(_templateObject, _commonStyle2.default.theme.sizing.labelWidth, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.text2, _commonStyle2.default.theme.colors.background2hover, _commonStyle2.default.theme.colors.text2, _commonStyle2.default.theme.colors.text2);
...
var _simpleColorPicker = __webpack_require__(55);
...
var Color = function (_EventEmitter) {
    ...
    function Color(root, opts, theme, uuid) {
        ...
        var value = __webpack_require__(14)(container, '', theme, 'calc(100% - ' + theme.sizing.labelWidth + ' - 12.5% - 0.75em)');
...
var tinycolor = __webpack_require__(15);
...
var properties = __webpack_require__(63);
var applyDefaultUnit = __webpack_require__(64);
...
module.exports = csjs(_templateObject, _commonStyle2.default.theme.colors.background2hover);
...
module.exports = csjs(_templateObject, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.text2, _commonStyle2.default.theme.colors.background2hover, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.text2, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.background2hover);
...
var Panel = exports.Panel = function () {
    function Panel(root, opts) {
        ...
        this.styles = __webpack_require__(73);
        ...
        if (opts.title && opts.barMode === 'none') __webpack_require__(74)(this.element, opts.title, opts.theme);
    }
    ...
    _createClass(Panel, [{
        ...
        value: function ToggleVisible() {
            if (this.element.classList.contains(this.styles['guify-panel-hidden'])) this.SetVisible(true);else this.SetVisible(false);
        }
    }]);
...
module.exports = csjs(_templateObject, _commonStyle2.default.theme.sizing.componentSpacing);
...
var ToastArea = exports.ToastArea = function () {
    function ToastArea(root, opts) {
        ...
        // Add menu bar styles to the head
        this.styles = __webpack_require__(77);
...
module.exports = csjs(_templateObject, _commonStyle2.default.theme.colors.background2, _commonStyle2.default.theme.colors.background1);
