...
var paramCase = __webpack_require__(28);
...
var GUI = function () {
    ...
    _createClass(GUI, [{
        ...
        value: function _ConstructElements() {
            ...
            if (this.opts.title && !this.opts.useMenuBar) __webpack_require__(58)(this.panel, this.opts.title, this.opts.theme);
        ...
        value: function RegisterVariable(object, property, opts) {

            if (!isstring(property) && property != null) throw new Error('Supplied property must be a string.');

            if (object && property) if (object[property] === undefined) throw new Error('Object ' + object + ' has no property \'' + property + '\'');
            ...
            var component = new this.components[opts.type](this.panel, opts, this.opts.theme, this.uuid);
            ...
            if (component.on) {
                ...
                component.on('input', function (data) {
                    if (object && property) object[property] = data;
...
var css = __webpack_require__(0);
var isnumeric = __webpack_require__(27);
...
var Range = function (_EventEmitter) {
    ...
    function Range(root, opts, theme, uuid) {
        ...
        var scaleValue = void 0,
            scaleValueInverse = void 0,
            logmin = void 0,
            logmax = void 0,
            logsign = void 0;

        var container = __webpack_require__(4)(root, opts.label);
        ...
        if (opts.scale === 'log') {
            ...
            scaleValue = scaleValueInverse = function scaleValueInverse(x) {
                return x;
            };
        }
        ...
        var value = __webpack_require__(6)(container, scaleValue(opts.initial), theme, '11%');

        setTimeout(function () {
            _this.emit('initialized', parseFloat(input.value));
        });
...
var NON_WORD_REGEXP = __webpack_require__(31)
...
var Checkbox = function (_EventEmitter) {
    ...
    function Checkbox(root, opts, theme, uuid) {
        ...
        setTimeout(function () {
            _this.emit('initialized', input.checked);
        });
...
var Select = function (_EventEmitter) {
    ...
    function Select(root, opts, theme, uuid) {
        ...
        container = __webpack_require__(4)(root, opts.label);
        __webpack_require__(5)(container, opts.label, theme);
...
var Text = function (_EventEmitter) {
    ...
    function Text(root, opts, theme, uuid) {
        ...
        setTimeout(function () {
            _this.emit('initialized', input.value);
        });
...
var prefix = __webpack_require__(53);
var isArray = __webpack_require__(54);
var properties = __webpack_require__(55);
var applyDefaultUnit = __webpack_require__(56);
...
var trim = __webpack_require__(57);
...
exports.default = function (root, opts, theme) {
