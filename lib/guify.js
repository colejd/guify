...
/* harmony import */ var _components_range__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/range */ "./src/components/range.js");
...
/* harmony import */ var _components_checkbox__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/checkbox */ "./src/components/checkbox.js");
...
/* harmony import */ var _components_text__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/text */ "./src/components/text.js");
/* harmony import */ var _components_color__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/color */ "./src/components/color.js");
/* harmony import */ var _components_folder__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/folder */ "./src/components/folder.js");
/* harmony import */ var _components_file__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/file */ "./src/components/file.js");
/* harmony import */ var _components_display__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/display */ "./src/components/display.js");
/* harmony import */ var _components_interval__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/interval */ "./src/components/interval.js");
...
var ComponentManager = /*#__PURE__*/function () {
  function ComponentManager() {
    ...
    this.uuid = uuid_v4__WEBPACK_IMPORTED_MODULE_0___default()();
    this.components = {
      'title': _components_title__WEBPACK_IMPORTED_MODULE_2__["default"],
      'range': _components_range__WEBPACK_IMPORTED_MODULE_3__["default"],
      ...
      'text': _components_text__WEBPACK_IMPORTED_MODULE_7__["default"],
      'color': _components_color__WEBPACK_IMPORTED_MODULE_8__["default"],
      'folder': _components_folder__WEBPACK_IMPORTED_MODULE_9__["default"],
      'file': _components_file__WEBPACK_IMPORTED_MODULE_10__["default"],
      'display': _components_display__WEBPACK_IMPORTED_MODULE_11__["default"],
      'interval': _components_interval__WEBPACK_IMPORTED_MODULE_12__["default"]
    };
  }
  /**
  ...
  _createClass(ComponentManager, [{
    ...
    value: function Create(root, opts) {
      ...
      var newComponent = new this.components[opts.type](root, opts, _theme__WEBPACK_IMPORTED_MODULE_1__.theme, this.uuid);
...
/* harmony import */ var styles_components_button_style_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! styles/components/button-style.js */ "./src/styles/components/button-style.js");
...
var Button = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Button(root, opts, theme, uuid) {
    ...
    _this.opts = opts;
    _this.container = __webpack_require__(/*! ./partials/container */ "./src/components/partials/container.js")(root, opts.label, theme);

    var input = _this.container.appendChild(document.createElement('button'));

    input.className = styles_components_button_style_js__WEBPACK_IMPORTED_MODULE_2__["default"]["guify-button"];
...
/* harmony import */ var dom_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dom-css */ "./node_modules/dom-css/index.js");
/* harmony import */ var dom_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(dom_css__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var styles_components_checkbox_style_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! styles/components/checkbox-style.js */ "./src/styles/components/checkbox-style.js");
/* harmony import */ var _partials_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./partials/container */ "./src/components/partials/container.js");
/* harmony import */ var _partials_label__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./partials/label */ "./src/components/partials/label.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var Checkbox = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Checkbox(root, opts, theme, uuid) {
    ...
    __webpack_require__(/*! ./partials/label */ "./src/components/partials/label.js")(_this.container, opts.label, theme);
    ...
    _this.input.className = styles_components_checkbox_style_js__WEBPACK_IMPORTED_MODULE_2__["default"]["guify-checkbox"]; // Add ARIA attribute to input based on label text
...
var Color = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Color(root, opts, theme, uuid) {
    ...
    var value = __webpack_require__(/*! ./partials/value */ "./src/components/partials/value.js")(_this.container, '', theme, "calc(100% - ".concat(theme.sizing.labelWidth, " - 12% - 0.5em)"));
...
/* harmony import */ var _partials_container__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./partials/container */ "./src/components/partials/container.js");
...
var Display = /*#__PURE__*/function () {
  function Display(root, opts, theme, uuid) {
    ...
    this.opts = opts;
    this.container = __webpack_require__(/*! ./partials/container */ "./src/components/partials/container.js")(root, opts.label, theme);

    __webpack_require__(/*! ./partials/label */ "./src/components/partials/label.js")(this.container, opts.label, theme);

    this.text = this.container.appendChild(document.createElement('div'));
    dom_css__WEBPACK_IMPORTED_MODULE_0___default()(this.text, {
      display: 'inline-block',
      height: 'unset',
...
var File = /*#__PURE__*/function (_EventEmitter) {
  ...
  function File(root, opts, theme, uuid) {
    ...
    _this.container.classList.add(styles_components_file_style_js__WEBPACK_IMPORTED_MODULE_2__["default"]["guify-file-container"]);
    ...
    _this.container.addEventListener('dragover', function (event) {
      ...
      _this.container.classList.add(styles_components_file_style_js__WEBPACK_IMPORTED_MODULE_2__["default"]["guify-dragover"]);
    });
    ...
    _this.container.addEventListener('dragleave', function (event) {
      ...
      _this.container.classList.remove(styles_components_file_style_js__WEBPACK_IMPORTED_MODULE_2__["default"]["guify-dragover"]);
    });
...
/* harmony import */ var dom_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dom-css */ "./node_modules/dom-css/index.js");
/* harmony import */ var dom_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dom_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var styles_components_folder_style_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! styles/components/folder-style.js */ "./src/styles/components/folder-style.js");
...
var Folder = /*#__PURE__*/function () {
  function Folder(root, opts, theme, uuid) {
    ...
    this.opts = opts;
    this.container = (0,_partials_container__WEBPACK_IMPORTED_MODULE_2__["default"])(root, opts.label, theme);
    this.container.classList.add(styles_components_folder_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-folder"]);
    ...
    dom_css__WEBPACK_IMPORTED_MODULE_0___default()(this.arrow, {
      'width': '1.5em'
    });
    ...
    this.folderContainer.classList.add(styles_components_folder_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-folder-contents"]);
  ...
  _createClass(Folder, [{
    ...
    value: function SetOpen(show) {
      ...
      if (show) {
        this.folderContainer.classList.remove(styles_components_folder_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-folder-closed"]);
        this.arrow.innerHTML = '&#9662;'; // Down triangle
      } else {
        this.folderContainer.classList.add(styles_components_folder_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-folder-closed"]);
...
var Interval = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Interval(root, opts, theme, uuid) {
    ...
    _this.input.className = styles_components_interval_style_js__WEBPACK_IMPORTED_MODULE_3__["default"]["guify-interval"];
    _this.handle = document.createElement("span");
    _this.handle.className = styles_components_interval_style_js__WEBPACK_IMPORTED_MODULE_3__["default"]["guify-interval-handle"];
    ...
    if (opts.scale === "log") {
      ...
      opts.initial = [_this.InverseScaleValue(is_numeric__WEBPACK_IMPORTED_MODULE_2___default()(opts.initial) ? opts.initial[0] : scaleValue(opts.min + (opts.max - opts.min) * 0.25)), _this.InverseScaleValue(is_numeric__WEBPACK_IMPORTED_MODULE_2___default()(opts.initial) ? opts.initial[1] : scaleValue(opts.min + (opts.max - opts.min) * 0.75))];
    ...
    _this.lValue = __webpack_require__(/*! ./partials/value */ "./src/components/partials/value.js")(_this.container, _this.ScaleValue(opts.initial[0]), theme, '11%', true);
    _this.rValue = __webpack_require__(/*! ./partials/value */ "./src/components/partials/value.js")(_this.container, _this.ScaleValue(opts.initial[1]), theme, '11%'); // Add ARIA attribute to input based on label text
...
var Range = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Range(root, opts, theme, uuid) {
    ...
    _this.input.className = styles_components_range_style_js__WEBPACK_IMPORTED_MODULE_3__["default"]["guify-range"]; // Add ARIA attribute to input based on label text
...
var Select = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Select(root, opts, theme, uuid) {
    ...
    _this.input.className = styles_components_select_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-select-dropdown"]; // Add ARIA attribute to input based on label text

    if (opts.label) _this.input.setAttribute('aria-label', opts.label);
    downTriangle = document.createElement('span');
    downTriangle.classList.add(styles_components_select_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-select-triangle"], styles_components_select_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-select-triangle--down"]);
    upTriangle = document.createElement('span');
    upTriangle.classList.add(styles_components_select_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-select-triangle"], styles_components_select_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-select-triangle--up"]);
    ...
    var StyleFocus = function StyleFocus() {
      downTriangle.classList.add(styles_components_select_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-select-triangle--down-highlight"]);
      upTriangle.classList.add(styles_components_select_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-select-triangle--up-highlight"]);
    };

    var StyleUnfocus = function StyleUnfocus() {
      downTriangle.classList.remove(styles_components_select_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-select-triangle--down-highlight"]);
      upTriangle.classList.remove(styles_components_select_style_js__WEBPACK_IMPORTED_MODULE_1__["default"]["guify-select-triangle--up-highlight"]);
    };
...
var Text = /*#__PURE__*/function (_EventEmitter) {
...
var Title = function Title(root, opts, theme) {
  ...
  this.opts = opts;
  this.container = (0,_partials_container__WEBPACK_IMPORTED_MODULE_1__["default"])(root, opts.label, theme);
  dom_css__WEBPACK_IMPORTED_MODULE_0___default()(this.container, {//'font-size': '13px'
  });
...
/* harmony import */ var dom_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dom-css */ "./node_modules/dom-css/index.js");
/* harmony import */ var dom_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dom_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var is_string__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! is-string */ "./node_modules/is-string/index.js");
...
/* harmony import */ var _styles_container_style_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./styles/container-style.js */ "./src/styles/container-style.js");
/* harmony import */ var _component_manager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component-manager */ "./src/component-manager.js");
/* harmony import */ var _menu_bar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./menu-bar */ "./src/menu-bar.js");
/* harmony import */ var _panel__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./panel */ "./src/panel.js");
/* harmony import */ var _toast_area__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./toast-area */ "./src/toast-area.js");
/* harmony import */ var screenfull__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! screenfull */ "./node_modules/screenfull/dist/screenfull.js");
/* harmony import */ var screenfull__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(screenfull__WEBPACK_IMPORTED_MODULE_9__);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var GUI = /*#__PURE__*/function () {
  function GUI(opts) {
    ...
    opts.open = opts.open || false; // Set theme global from opts

    var chosenTheme = opts.theme;
    if (opts.theme === undefined) chosenTheme = (_themes__WEBPACK_IMPORTED_MODULE_2___default().dark);

    if (is_string__WEBPACK_IMPORTED_MODULE_1___default()(opts.theme)) {
      if ((_themes__WEBPACK_IMPORTED_MODULE_2___default())[opts.theme] === undefined) {
        console.error("There is no theme preset with the name '".concat(opts.theme, "'! Defaulting to dark theme."));
        chosenTheme = (_themes__WEBPACK_IMPORTED_MODULE_2___default().dark);
      } else chosenTheme = (_themes__WEBPACK_IMPORTED_MODULE_2___default())[opts.theme];
    }

    _theme__WEBPACK_IMPORTED_MODULE_3__.theme.Set(chosenTheme);

    this._ConstructElements();

    this._LoadStyles();

    this.componentManager = new _component_manager__WEBPACK_IMPORTED_MODULE_5__.ComponentManager();
  ...
  _createClass(GUI, [{
    ...
    value: function _LoadStyles() {
      ...
      if (_theme__WEBPACK_IMPORTED_MODULE_3__.theme.font) {
        // Set default font to theme font
        if (_theme__WEBPACK_IMPORTED_MODULE_3__.theme.font.fontURL) AppendFont(_theme__WEBPACK_IMPORTED_MODULE_3__.theme.font.fontURL);
        if (_theme__WEBPACK_IMPORTED_MODULE_3__.theme.font.fontFamily) dom_css__WEBPACK_IMPORTED_MODULE_0___default()(this.container, 'font-family', _theme__WEBPACK_IMPORTED_MODULE_3__.theme.font.fontFamily);
        if (_theme__WEBPACK_IMPORTED_MODULE_3__.theme.font.fontSize) dom_css__WEBPACK_IMPORTED_MODULE_0___default()(this.container, 'font-size', _theme__WEBPACK_IMPORTED_MODULE_3__.theme.font.fontSize);
        if (_theme__WEBPACK_IMPORTED_MODULE_3__.theme.font.fontWeight) dom_css__WEBPACK_IMPORTED_MODULE_0___default()(this.container, 'font-weight', _theme__WEBPACK_IMPORTED_MODULE_3__.theme.font.fontWeight);
      } else {
    ...
    value: function _ConstructElements() {
      ...
      this.container.classList.add(_styles_container_style_js__WEBPACK_IMPORTED_MODULE_4__["default"]["guify-container"]);
      ...
      if (this.hasRoot && this.opts.barMode == 'above') {
        containerCSS.top = "-".concat(_theme__WEBPACK_IMPORTED_MODULE_3__.theme.sizing.menuBarHeight);
      }
      ...
      if (this.opts.barMode !== 'none') {
        this.bar = new _menu_bar__WEBPACK_IMPORTED_MODULE_6__.MenuBar(this.container, this.opts);
      ...
      this.panel = new _panel__WEBPACK_IMPORTED_MODULE_7__.Panel(this.container, this.opts); // Show the panel by default if there's no menu bar or it's requested
      ...
      this.toaster = new _toast_area__WEBPACK_IMPORTED_MODULE_8__.ToastArea(this.container, this.opts);
    }
    /**
    ...
    value: function ToggleFullscreen() {
      var isFullscreen = (screenfull__WEBPACK_IMPORTED_MODULE_9___default().isFullscreen);

      if (isFullscreen) {
        screenfull__WEBPACK_IMPORTED_MODULE_9___default().exit();
      } else {
        console.log("Request fullscreen");
        screenfull__WEBPACK_IMPORTED_MODULE_9___default().request(this.opts.root);
      }
    }
  }]);
...
/* harmony import */ var _styles_menu_bar_style_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./styles/menu-bar-style.js */ "./src/styles/menu-bar-style.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var MenuBar = /*#__PURE__*/function (_EventEmitter) {
  ...
  function MenuBar(root, opts) {
    ...
    _this = _super.call(this); // Add menu bar styles to the head

    _this.styles = _styles_menu_bar_style_js__WEBPACK_IMPORTED_MODULE_4__["default"]; // Create menu bar
    ...
    dom_css__WEBPACK_IMPORTED_MODULE_0___default()(menuButton, {
    ...
    if ((screenfull__WEBPACK_IMPORTED_MODULE_3___default().isEnabled)) {
      ...
      dom_css__WEBPACK_IMPORTED_MODULE_0___default()(fullscreenButton, {
  ...
  return MenuBar;
}((wolfy87_eventemitter__WEBPACK_IMPORTED_MODULE_1___default()));
...
var Panel = /*#__PURE__*/function () {
  function Panel(root, opts) {
    ...
    this.opts = opts; // Add styles to the head

    this.styles = _styles_panel_style_js__WEBPACK_IMPORTED_MODULE_2__["default"]; // Container the panel will sit in
    ...
    this.panel.className = this.styles['guify-panel']; // Add a title to the panel

    if (opts.barMode === 'none' && opts.title) __webpack_require__(/*! ./components/partials/header */ "./src/components/partials/header.js")(this.panel, opts.title, _theme__WEBPACK_IMPORTED_MODULE_1__.theme);
  }
  /**
  ...
  _createClass(Panel, [{
    ...
    value: function _MakeToggleButton() {
      ...
      dom_css__WEBPACK_IMPORTED_MODULE_0___default()(this.menuButton, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (csjs(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n.guify-button {\n    box-sizing: border-box !important;\n    color: ", ";\n    background-color: ", ";\n\n    position: absolute;\n    text-align: center;\n    height: ", ";\n    line-height: ", ";\n    padding-top: 0px;\n    padding-bottom: 0px;\n    width: calc(100% - ", ");\n    border: none;\n    cursor: pointer;\n    right: 0;\n    font-family: inherit;\n}\n\n\n.guify-button:focus {\n    outline:none;\n}\n.guify-button::-moz-focus-inner {\n    border:0;\n}\n\n.guify-button:hover,\n.guify-button:focus {\n    color: ", ";\n    background-color: ", ";\n}\n\n.guify-button:active {\n    color: ", " !important;\n    background-color: ", " !important;\n}\n\n"])), _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textSecondary, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.labelWidth, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textHover, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentForeground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textActive, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentActive));
...
var borderSize = '4px';
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (csjs(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\ninput[type=checkbox].guify-checkbox {\n    opacity: 0;\n    appearance: none;\n    -moz-appearance: none;\n    -webkit-appearance: none;\n    margin: 0;\n    border-radius: 0;\n    cursor: pointer;\n}\n\ninput[type=checkbox].guify-checkbox + label {\n    margin: 0;\n}\n\ninput[type=checkbox].guify-checkbox + label:before {\n    content: \"\";\n    display: inline-block;\n    width: ", ";\n    height: ", ";\n    padding: 0;\n    margin: 0;\n    vertical-align: middle;\n    background-color: ", ";\n    border-radius: 0px;\n    cursor: pointer;\n    box-sizing: content-box;\n    -moz-box-sizing: content-box;\n    -webkit-box-sizing: content-box;\n\n}\n\n/* Hover style */\ninput[type=checkbox].guify-checkbox:hover + label:before {\n    width: calc(", " - (", " * 2));\n    height: calc(", " - (", " * 2));\n    background-color: ", ";\n    border: solid 4px ", ";\n}\n\n/* Checked style */\ninput[type=checkbox]:checked.guify-checkbox + label:before {\n    width: calc(", " - (", " * 2));\n    height: calc(", " - (", " * 2));\n    background-color: ", ";\n    border: solid ", " ", ";\n}\n\n/* Focused and checked */\ninput[type=checkbox]:checked.guify-checkbox:focus + label:before {\n    width: calc(", " - (", " * 2));\n    height: calc(", " - (", " * 2));\n    background-color: ", ";\n    border: solid ", " ", ";\n}\n\n/* Focus and unchecked */\ninput[type=checkbox].guify-checkbox:focus + label:before {\n    background-color: ", ";\n}\n\n"])), _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, borderSize, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, borderSize, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackgroundHover, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, borderSize, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, borderSize, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentForeground, borderSize, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, borderSize, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, borderSize, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentForeground, borderSize, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackgroundHover, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackgroundHover));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (csjs(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n.guify-file-container {\n    display: inline-block;\n    outline: none;\n    padding-top: 8px;\n    padding-bottom: 8px;\n    color: ", ";\n    background-color: ", ";\n}\n\n.guify-file-container:hover,\n.guify-file-container:focus {\n    color: ", ";\n    background-color: ", ";\n}\n\n.guify-file-container:active {\n    color: ", " !important;\n    background-color: ", " !important;\n}\n\n.guify-dragover {\n    background-color: ", ";\n    box-shadow: inset 0 0 0 3px ", ";\n}\n\n\n"])), _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textPrimary, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textHover, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentForeground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textActive, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentActive, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentForeground));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (csjs(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n.guify-folder {\n    cursor: pointer;\n    padding-left: 0.5em;\n    color: ", ";\n}\n\n.guify-folder div {\n    display: inline-block;\n    vertical-align: sub;\n    line-height: calc(", " + 5px);\n}\n\n.guify-folder:hover,\n.guify-folder:focus {\n    color: ", ";\n    background-color: ", ";\n    outline: none;\n}\n\n\n.guify-folder-contents {\n    display: block;\n    box-sizing: border-box;\n    padding-left: 14px;\n    margin-bottom: 5px;\n    border-left: 2px solid ", ";\n}\n\n.guify-folder-contents.guify-folder-closed {\n    height: 0;\n    display: none;\n}\n\n\n"])), _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textPrimary, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textHover, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentForeground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground));
...
var trackColor = _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground;
var thumbColor = _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentForeground;
var thumbHighlight = _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentActive;
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (csjs(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n.guify-interval {\n    -webkit-appearance: none;\n    position: absolute;\n    height: 20px;\n    margin: 0px 0;\n    width: 33%;\n    left: 54.5%;\n    background-color: ", ";\n    cursor: ew-resize;\n\n    -webkit-touch-callout: none;\n    -webkit-user-select: none;\n    -khtml-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n}\n.guify-interval-handle {\n    background-color: ", ";\n    position: absolute;\n    height: ", ";\n    min-width: 1px;\n}\n.guify-interval-handle:focus {\n    background: ", ";\n}\n"])), trackColor, thumbColor, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, thumbHighlight));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (csjs(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n.guify-select-dropdown {\n    display: inline-block;\n    position: absolute;\n    width: calc(100% - ", ");\n    padding-left: 1.5%;\n    height: ", ";\n    border: none;\n    border-radius: 0;\n    -webkit-appearance: none;\n    -moz-appearance: none;\n    -o-appearance:none;\n    appearance: none;\n    font-family: inherit;\n    background-color: ", ";\n    color: ", ";\n    box-sizing: border-box !important;\n    -moz-box-sizing: border-box !important;\n    -webkit-box-sizing: border-box !important;\n}\n\n/* Disable default outline since we're providing our own */\n.guify-select-dropdown:focus {\n    outline: none;\n}\n.guify-select-dropdown::-moz-focus-inner {\n    border: 0;\n}\n\n\n.guify-select-dropdown:focus,\n.guify-select-dropdown:hover {\n    color: ", ";\n    background-color: ", ";\n}\n\n.guify-select-dropdown::-ms-expand {\n    display:none;\n}\n.guify-select-triangle {\n    content: ' ';\n    border-right: 3px solid transparent;\n    border-left: 3px solid transparent;\n    line-height: ", ";\n    position: absolute;\n    right: 2.5%;\n    z-index: 1;\n    pointer-events: none;\n}\n\n.guify-select-triangle--up {\n    bottom: 55%;\n    border-bottom: 5px solid ", ";\n    border-top: 0px transparent;\n}\n\n.guify-select-triangle--down {\n    top: 55%;\n    border-top: 5px solid ", ";\n    border-bottom: 0px transparent;\n}\n\n.guify-select-triangle--up-highlight {\n    border-bottom-color: ", ";\n}\n\n.guify-select-triangle--down-highlight {\n    border-top-color: ", ";\n}\n\n"])), _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.labelWidth, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textSecondary, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textHover, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentForeground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.componentHeight, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textSecondary, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textSecondary, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textHover, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textHover));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (csjs(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n.guify-bar {\n    background-color: ", ";\n    height: ", ";\n    width: 100%;\n    opacity: 1.0;\n    position: relative;\n    cursor: default;\n}\n\n.guify-bar-title {\n    color: ", ";\n    text-align: center;\n    width: 100%;\n    position: absolute;\n    top: 0;\n    line-height: ", ";\n    color: ", ";\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n}\n\n.guify-bar-button {\n    text-align: center;\n    border: none;\n    cursor: pointer;\n    font-family: inherit;\n    height: 100%;\n    position: absolute;\n    top: 0;\n    color: ", ";\n    background-color: ", ";\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n    margin: 0;\n\n}\n\n/* Hide default accessibility outlines since we're providing our own visual feedback */\n.guify-bar-button:focus {\n    outline:none;\n}\n.guify-bar-button::-moz-focus-inner {\n    border:0;\n}\n\n.guify-bar-button:hover,\n.guify-bar-button:focus {\n    color: ", ";\n    background-color: ", ";\n}\n\n.guify-bar-button:active {\n    color: ", " !important;\n    background-color: ", " !important;\n}\n\n\n"])), _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.menuBarBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.menuBarHeight, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.text1, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.sizing.menuBarHeight, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.menuBarText, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textPrimary, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textHover, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentForeground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textActive, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.componentActive));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (csjs(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\n.guify-toast-notification {\n    box-sizing: border-box;\n    color: theme.colors.text1;\n    position: relative;\n    width: 100%;\n    /* height: 20px; */\n    padding: 8px;\n    padding-left: 20px;\n    padding-right: 20px;\n    text-align: center;\n    font-family: 'Hack', monospace;\n    font-size: 11px;\n}\n\n.guify-toast-area .guify-toast-notification:nth-child(odd) {\n    color: ", ";\n    background-color: ", ";\n}\n\n.guify-toast-area .guify-toast-notification:nth-child(even) {\n    color: ", ";\n    background-color: ", ";\n}\n\n.guify-toast-close-button {\n    color: ", ";\n    background: transparent;\n    position: absolute;\n    textAlign: center;\n    margin-top: auto;\n    margin-bottom: auto;\n    border: none;\n    cursor: pointer;\n    top: 0;\n    bottom: 0;\n    right: 8px;\n}\n\n"])), _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textPrimary, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.panelBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textPrimary, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.menuBarBackground, _theme_js__WEBPACK_IMPORTED_MODULE_0__.theme.colors.textPrimary));
...
var Theme = /*#__PURE__*/function () {
  function Theme() {
    ...
    // This is a bug.
    this.Set((_themes__WEBPACK_IMPORTED_MODULE_0___default().dark));
  }
...
var ToastArea = /*#__PURE__*/function () {
  function ToastArea(root, opts) {
    _classCallCheck(this, ToastArea);

    this.opts = opts; // Add toast area styles to the head

    this.styles = _styles_toast_area_style_js__WEBPACK_IMPORTED_MODULE_2__["default"]; // Make toast area

    this.element = root.appendChild(document.createElement('div'));
    this.element.classList.add(this.styles['guify-toast-area']);
    dom_css__WEBPACK_IMPORTED_MODULE_0___default()(this.element, {
      position: 'absolute',
      'width': '100%'
    });
  }
  ...
  _createClass(ToastArea, [{
    ...
    value: function CreateToast(message) {
      ...
      dom_css__WEBPACK_IMPORTED_MODULE_0___default()(toast, {// Animation stuff
      ...
      var TransitionOut = function TransitionOut() {
        toast.blur();
        dom_css__WEBPACK_IMPORTED_MODULE_0___default()(toast, {
