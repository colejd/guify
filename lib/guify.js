...
/* harmony import */ var _menu_bar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./menu-bar */ "./src/menu-bar.js");
/* harmony import */ var _panel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./panel */ "./src/panel.js");
/* harmony import */ var _toast_area__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./toast-area */ "./src/toast-area.js");
  ...
  _createClass(GUI, [{
    ...
    value: function _ConstructElements() {
      ...
      if (this.opts.barMode !== 'none') {
        this.bar = new _menu_bar__WEBPACK_IMPORTED_MODULE_4__.MenuBar(this.container, this.opts, this.theme);
      ...
      this.panel = new _panel__WEBPACK_IMPORTED_MODULE_5__.Panel(this.container, this.opts, this.theme); // Show the panel by default if there's no menu bar or it's requested
      ...
      this.toaster = new _toast_area__WEBPACK_IMPORTED_MODULE_6__.ToastArea(this.container, this.opts, this.theme);
    }
    /**
