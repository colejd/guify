...
var GUI = function () {
    function GUI(opts) {
        ...
        __webpack_require__(6)(this.panel, { label: 'Test Title' }, opts.theme);
        __webpack_require__(6)(this.panel, { label: 'Test Title 2: Electric Boogaloo' }, opts.theme);
    ...
    _createClass(GUI, [{
        ...
        key: 'ConstructElements',
        value: function ConstructElements() {
            var _this = this;
            ...
            if (this.opts.title && !this.opts.useMenuBar) __webpack_require__(59)(this.panel, this.opts.title, this.opts.theme);
...
var Range = function (_EventEmitter) {
    ...
    function Range(root, opts, theme, uuid) {
        ...
        var value = __webpack_require__(7)(container, scaleValue(opts.initial), theme, '11%');
...
var Color = function (_EventEmitter) {
    ...
    function Color(root, opts, theme, uuid) {
        ...
        var value = __webpack_require__(7)(container, '', theme, '46%');
