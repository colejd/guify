    ...
    _createClass(GUI, [{
        ...
        value: function _ConstructElements() {
            ...
            (0, _domCss2.default)(this.container, {
                top: this.opts.barMode == 'above' && this.hasRoot ? '-' + _theme.theme.sizing.menuBarHeight : '0'
            });
...
var Range = function (_EventEmitter) {
    ...
    function Range(root, opts, theme, uuid) {
        ...
        _this.valueComponent = __webpack_require__(13)(container, _this.ScaleValue(opts.initial), theme, '11%');
...
module.exports = csjs(_templateObject, trackColor, thumbColor, thumbHighlight, trackColor, _theme.theme.colors.background2hover, thumbColor, trackColor, trackColor, _theme.theme.colors.background2hover, _theme.theme.colors.background2hover, thumbColor, thumbHighlight, thumbHighlight);
...
module.exports = csjs(_templateObject, _theme.theme.colors.textSecondary, _theme.theme.colors.componentBackground, _theme.theme.sizing.labelWidth, _theme.theme.colors.textHover, _theme.theme.colors.componentForeground, _theme.theme.colors.textActive, _theme.theme.colors.componentActive);
...
module.exports = csjs(_templateObject, _theme.theme.colors.componentBackground, _theme.theme.colors.componentBackgroundHover, _theme.theme.colors.componentBackground, _theme.theme.colors.componentForeground, _theme.theme.colors.componentBackground, _theme.theme.colors.componentForeground, _theme.theme.colors.componentBackgroundHover, _theme.theme.colors.componentBackgroundHover);
...
module.exports = csjs(_templateObject, _theme.theme.sizing.labelWidth, _theme.theme.colors.componentBackground, _theme.theme.colors.textSecondary, _theme.theme.colors.textHover, _theme.theme.colors.componentForeground, _theme.theme.colors.textSecondary, _theme.theme.colors.textSecondary, _theme.theme.colors.textHover, _theme.theme.colors.textHover);
...
var Color = function (_EventEmitter) {
    ...
    function Color(root, opts, theme, uuid) {
        ...
        var value = __webpack_require__(13)(container, '', theme, 'calc(100% - ' + theme.sizing.labelWidth + ' - 12.5% - 0.75em)');
...
module.exports = csjs(_templateObject, _theme.theme.colors.textPrimary, _theme.theme.colors.textHover, _theme.theme.colors.componentForeground, _theme.theme.colors.componentBackground);
    ...
    function MenuBar(root, opts) {
        ...
        if (opts.title) {
            ...
            (0, _domCss2.default)(text, {
                'color': _theme.theme.colors.text1
            });
        }
...
module.exports = csjs(_templateObject, _theme.theme.colors.menuBarBackground, _theme.theme.sizing.menuBarHeight, _theme.theme.sizing.menuBarHeight, _theme.theme.sizing.menuBarContentHeight, _theme.theme.sizing.menuBarContentHeight, _theme.theme.colors.menuBarText, _theme.theme.sizing.menuBarContentHeight, _theme.theme.sizing.menuBarHeight, _theme.theme.sizing.menuBarContentHeight, _theme.theme.colors.textPrimary, _theme.theme.colors.componentBackground, _theme.theme.colors.textHover, _theme.theme.colors.componentForeground, _theme.theme.colors.textActive, _theme.theme.colors.componentActive);
...
var Panel = exports.Panel = function () {
    function Panel(root, opts) {
        ...
        (0, _domCss2.default)(this.element, {
            background: _theme.theme.colors.panelBackground,
            width: opts.width,
        ...
        if (opts.title && opts.barMode === 'none') __webpack_require__(73)(this.element, opts.title, _theme.theme);
    }
...
module.exports = csjs(_templateObject, _theme.theme.sizing.componentSpacing);
...
module.exports = csjs(_templateObject, _theme.theme.colors.panelBackground, _theme.theme.colors.menuBarBackground);
