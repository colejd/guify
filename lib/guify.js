...
var _themes = __webpack_require__(23);
...
var GUI = function () {
    ...
    _createClass(GUI, [{
        ...
        value: function _ConstructElements() {
            ...
            (0, _domCss2.default)(this.toastContainer, {
                position: 'absolute',
                'width': '100%'
            });
        }
        ...
        value: function TogglePanelVisible() {
            if (this.panel.classList.contains('guify-panel-hidden')) this.SetPanelVisible(true);else this.SetPanelVisible(false);
        }
...
var _simpleColorPicker = __webpack_require__(48);
