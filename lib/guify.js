...
var Range = function (_EventEmitter) {
    ...
    function Range(root, opts, theme, uuid) {
        ...
        _this.valueComponent = __webpack_require__(6)(_this.container, _this._Position(opts.initial), theme, '16%');
        // Add ARIA attribute to input based on label text
        ...
        _this.input.oninput = function (data) {
            ...
            _this.valueComponent.value = _this._FormatNumber(scaledValue);
