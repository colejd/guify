...
var ComponentManager = /*#__PURE__*/function () {
  ...
  _createClass(ComponentManager, [{
    ...
    value: function Create(root, opts) {
      ...
      var newComponent = new this.components[opts.type](root, opts, _theme__WEBPACK_IMPORTED_MODULE_1__.theme, (0,uuid__WEBPACK_IMPORTED_MODULE_0__.v4)());
...
var Text = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Text(root, opts, theme, uuid) {
    ...
    if (!_classStaticPrivateFieldSpecGet(Text, Text, _supportedInputListenModes).includes(_this.listenMode)) {
      console.error("listenMode \"".concat(listenMode, "\" is not supported for text component \"").concat(opts.label, "\"! Falling back on \"input\"."));
    }
