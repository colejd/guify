...
var Button = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Button(root, opts, theme, uuid) {
    ...
    _this.opts = opts;
    _this.styles = (0,styles_components_button_style_js__WEBPACK_IMPORTED_MODULE_2__["default"])(theme);
...
var Checkbox = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Checkbox(root, opts, theme, uuid) {
    ...
    _this = _super.call(this);
    _this.opts = opts;
    _this.styles = (0,styles_components_checkbox_style_js__WEBPACK_IMPORTED_MODULE_2__["default"])(theme);
    _this.container = (0,_partials_container__WEBPACK_IMPORTED_MODULE_3__["default"])(root, opts.label, theme);
...
var Folder = /*#__PURE__*/function () {
  function Folder(root, opts, theme, uuid) {
    ...
    this.opts = opts;
    this.styles = (0,styles_components_folder_style_js__WEBPACK_IMPORTED_MODULE_1__["default"])(theme);
    this.container = (0,_partials_container__WEBPACK_IMPORTED_MODULE_2__["default"])(root, opts.label, theme);
    this.container.classList.add((0,styles_components_folder_style_js__WEBPACK_IMPORTED_MODULE_1__["default"])(theme)['guify-folder']);
...
var Panel = /*#__PURE__*/function () {
  function Panel(root, opts, theme) {
    ...
    this.opts = opts;
    this.styles = (0,_styles_panel_style_js__WEBPACK_IMPORTED_MODULE_1__["default"])(theme); // Container the panel will sit in
    ...
    if (opts.barMode === 'none' && opts.title) __webpack_require__(/*! ./components/partials/header */ "./src/components/partials/header.js")(this.panel, opts.title, theme);
  }
  /**
...
var ToastArea = /*#__PURE__*/function () {
  function ToastArea(root, opts, theme) {
    ...
    this.opts = opts;
    this.styles = (0,_styles_toast_area_style_js__WEBPACK_IMPORTED_MODULE_1__["default"])(theme); // Make toast area
