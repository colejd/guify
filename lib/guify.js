...
var Range = function (_EventEmitter) {
    ...
    function Range(root, opts, theme, uuid) {
        ...
        _this.valueComponent = __webpack_require__(12)(container, _this.ScaleValue(opts.initial), theme, '16%');
        // Add ARIA attribute to input based on label text
...
var Color = function (_EventEmitter) {
    ...
    function Color(root, opts, theme, uuid) {
        ...
        var value = __webpack_require__(12)(container, '', theme, 'calc(100% - ' + theme.sizing.labelWidth + ' - 12% - 0.5em)');
