...
var GUI = function () {
    function GUI(opts) {
        var componentsList = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
        ...
        try {
            for (var _iterator = componentsList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var componentOpts = _step.value;
