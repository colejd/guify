...
var Folder = /*#__PURE__*/function (_ComponentBase) {
  ...
  _createClass(Folder, [{
    ...
    value: function SetEnabled(enabled) {
      if (enabled === true) {
        this.container.classList.remove(styles_components_folder_style_js__WEBPACK_IMPORTED_MODULE_2__["default"].disabled);
      } else {
        this.container.classList.add(styles_components_folder_style_js__WEBPACK_IMPORTED_MODULE_2__["default"].disabled);
      }
    }
  }]);
