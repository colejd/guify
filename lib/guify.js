...
var GUI = function () {
    function GUI(opts) {
        ...
        this.components = {
            ...
            'display': __webpack_require__(66)
        };
    ...
    _createClass(GUI, [{
        ...
        value: function _ConstructElements() {
            ...
            if (this.opts.title && !this.opts.useMenuBar) __webpack_require__(65)(this.panel, this.opts.title, this.opts.theme);
    ...
    function File(root, opts, theme, uuid) {
        ...
        var FileDropped = function FileDropped(event) {
            ...
            reader.onload = function () {
                ...
                _this.fileLabel.innerHTML = URL.createObjectURL(files[0]);
