...
var _screenfull = __webpack_require__(14);
...
var Range = function (_EventEmitter) {
    ...
    function Range(root, opts, theme, uuid) {
        ...
        _this.valueComponent = __webpack_require__(12)(_this.container, _this.ScaleValue(opts.initial), theme, '16%');
        // Add ARIA attribute to input based on label text
...
module.exports.getCss = __webpack_require__(10);
...
var cssKey = __webpack_require__(9);
...
var Color = function (_EventEmitter) {
    ...
    function Color(root, opts, theme, uuid) {
        ...
        var value = __webpack_require__(12)(_this.container, '', theme, 'calc(100% - ' + theme.sizing.labelWidth + ' - 12% - 0.5em)');
...
var Panel = exports.Panel = function () {
    function Panel(root, opts) {
        ...
        if (opts.barMode === 'none' && opts.title) __webpack_require__(74)(this.panel, opts.title, _theme.theme);
    }
