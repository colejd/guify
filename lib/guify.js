...
var Range = function (_EventEmitter) {
    ...
    function Range(root, opts, theme, uuid) {
        ...
        if (opts.scale === 'log') {
            ...
            _this.min = Math.log((0, _isNumeric2.default)(opts.min) ? opts.min : 0.000001); // This cannot be 0
            _this.max = Math.log((0, _isNumeric2.default)(opts.max) ? opts.max : 100);

            _this.scale = (_this.max - _this.min) / (_this.maxPos - _this.minPos);

            opts.initial = (0, _isNumeric2.default)(opts.initial) ? opts.initial : (_this.min + _this.max) * 0.5;
            ...
            _this.minPos = (0, _isNumeric2.default)(opts.min) ? opts.min : 0;
            _this.maxPos = (0, _isNumeric2.default)(opts.max) ? opts.max : 100;
        ...
        _this.valueComponent = __webpack_require__(6)(_this.container, _this.Position(opts.initial), theme, '16%');
        // Add ARIA attribute to input based on label text
        ...
        _this.input.oninput = function (data) {
            ...
            var scaledValue = _this.Value(position);
        ...
        _this.valueComponent.onchange = function () {
            ...
            if (Number(parseFloat(rawValue)) == rawValue) {
                ...
                value = _this.ValidatedInputValue(value);
    ...
    _createClass(Range, [{
        ...
        value: function Value(position) {
            if (this.opts.scale === 'log') {
                ...
                var rangePos = (position - this.minPos) * this.scale + this.min;
        ...
        key: 'ValidatedInputValue',
        value: function ValidatedInputValue(value) {
            var newValue;
            if (this.opts.scale === 'log') {
                ...
                // Quantize to step
                newValue = Math.ceil((newValue - this.min) / this.opts.step) * this.opts.step + this.min;
            }
            return newValue;
        }
    }, {
        ...
        value: function SetValue(value) {
            var validated = this.ValidatedInputValue(value);
